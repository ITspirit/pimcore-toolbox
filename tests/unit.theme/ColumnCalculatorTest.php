...
class ColumnCalculatorTest extends BundleTestCase
{
    ...
    public function testDefaultColumnCalculatorB5()
    {
        /** @var ColumnCalculatorInterface $columnCalculator */
        $columnCalculator = $this->getContainer()->get(\ToolboxBundle\Calculator\Bootstrap5\ColumnCalculator::class);
        $calculatedValue = $columnCalculator->calculateColumns('column_4_4_4');
    ...
    public function testOffsetColumnCalculatorB5()
    {
        /** @var ColumnCalculatorInterface $columnCalculator */
        $columnCalculator = $this->getContainer()->get(\ToolboxBundle\Calculator\Bootstrap5\ColumnCalculator::class);
        $calculatedValue = $columnCalculator->calculateColumns('column_o1_4_4_4');
    ...
    public function testAdjustedColumnCalculatorB5()
    {
        /** @var ColumnCalculatorInterface $columnCalculator */
        $columnCalculator = $this->getContainer()->get(\ToolboxBundle\Calculator\Bootstrap5\ColumnCalculator::class);
        $custom = [
